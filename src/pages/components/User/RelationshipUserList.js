...
const URL = './user/getRelationshipManagerUser';
    ...
    const columns = [
        ...
        // { field: 'tradeName', headerName: 'Dealership', width: 200 },
        {
            ...
            getActions: (params) => {
                ...
                ] : params.row.blocked == "0" ? user_type == "admin" ?
                    [
        ...
        <div style={{ marginTop: '75px', padding: '25px' }}>
            ...
            <div className="GridContent">
                <Box sx={{ flexGrow: 1, padding: '0px', height: 'auto', width: '100%' }}>
                    ...
                    />
                    <RelationshipModelComponent
                        isAddButton={isAddButton}
                        isCommissionUpdate={isCommissionUpdate}
                        setOpen={setOpen}
                        open={open}
                        rowData={editData}
                        setRefreshData={setRefreshData}
                        setIsCommissionUpdate={setIsCommissionUpdate}
                        trackno={trackno}
                    />
...
export default RelationshipUserList;
