...
export default function AppearanceD({ productIndex, setProductIndex, setProductName, setProductCost, handleNext }) {
    ...
    const ProductData = (e) => {
        ...
        setProductName(`Appearance Packages - Rust Shield - Extended  (${tabLabels[value]})`);
        handleNext();
    }
    return (
        <Box
                        ...
                        <Grid item xs={12} lg={12}>
                            <Box sx={{ padding: 2, border: '2px solid red', borderRadius: '8px' }}>
                                <Typography variant="h6" sx={{ fontSize: '1.3rem', fontWeight: 'bold', overflowWrap: 'break-word' }}>
                                    <b>Bronze Powertrain Plus $1500 per claim ({tabLabels[index]})</b>
                                </Typography>
                                ...
                                <Typography variant="h6" sx={{ fontSize: '0.875rem', fontWeight: 'bold', }}>
                                    For vehicles with less than 250,000 KMs
                                    and less than 11 years old
                                    Affordable $75 Deductible per claim
                                </Typography>
                                <Typography variant="h6" sx={{ fontSize: '0.875rem', fontWeight: 'bold', }}>
                                    Covered Components
                                </Typography>
                                ...
                                <ul>
                                    <li style={{ fontSize: '0.875rem' }}><b>No Limits Per Claim</b>With a liability cap of $20,000, our Plans
                                        offer exceptional coverage.</li>
                                    ...
                                    <li style={{ fontSize: '0.875rem' }}><b>Coverage for Vehicles Less than 7
                                        Years Old</b>We provide tailored plans for new or
                                        used vehicles of any age. Speak with one of our Customer Service Associates
