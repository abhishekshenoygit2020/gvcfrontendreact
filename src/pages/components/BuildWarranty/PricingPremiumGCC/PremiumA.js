...
export default function PremiumA({ productIndex, setProductIndex, setProductName, setProductCost, handleNext }) {
    ...
    const ProductData = (e) => {
        setProductCost("500");
        setProductName(`Premium 3 Star Plan`);
        handleNext();
    }
    return (
        <Box
                    ...
                    <Grid item xs={12} lg={12}>
                        <Box sx={{ padding: 2, border: '2px solid red', borderRadius: '8px' }}>
                            <Typography variant="h6" sx={{ fontSize: '1.3rem', fontWeight: 'bold', overflowWrap: 'break-word' }}>
                                <b>The Following Components and Systems are Covered in the 3 Star Plan  </b>
                            </Typography>
