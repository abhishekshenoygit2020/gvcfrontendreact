...
export default function EssentialB({ productIndex, setProductIndex, setProductName, setProductCost, handleNext }) {
    ...
    const ProductData = (e) => {
        setProductCost("500");
        setProductName(`Essential Powertrain Plus Plan`);
        handleNext();
    }
    return (
        <Box
                ...
                <Grid container spacing={2}>
                    <Grid item xs={12} lg={12}>
                        <Box sx={{ padding: 2, border: '2px solid red', borderRadius: '8px' }}>
                            ...
                            For vehicles 10 years old and newer                    with less than 250,000 KMs
                            </Typography>
                            <ul>
