...
export default function SilverB({ productIndex, setProductIndex, setProductName, setProductCost, handleNext }) {
    ...
    const ProductData = (e) => {
        setProductCost("500");
        setProductName(`Silver Powertrain PLUS Plans`);
        handleNext();
    }
    return (
        <Box
                    ...
                    <Grid item xs={12} lg={12}>
                        <Box sx={{ padding: 2, border: '2px solid red', borderRadius: '8px' }}>
                            <Typography variant="h6" sx={{ fontSize: '1.3rem', fontWeight: 'bold', overflowWrap: 'break-word' }}>
                                <b>The Following Components and Systems are Covered in the Silver Powertrain PLUS Plans </b>
                            </Typography>
...
and less than 11 years old
                            ...
                            <ul>
                                <li style={{ fontSize: '0.875rem' }}><b>Affordable $75 Deductible</b>Each plan includes a $75 deductible per
                                claim.</li>
...
repair shop.</li>
                                <li style={{ fontSize: '0.875rem' }}><b>Choose No Distance Restrictions:</b>Our 1- or 2-Year Silver Powertrain Plus
Plans include an option for unlimited
kilometers.</li>
                            </ul>
