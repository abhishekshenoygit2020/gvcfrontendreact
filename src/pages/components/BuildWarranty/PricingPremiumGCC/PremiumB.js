...
export default function PremiumB({ productIndex, setProductIndex, setProductName, setProductCost, handleNext }) {
    ...
    const ProductData = (e) => {
        setProductCost("1000");
        setProductName(`Premium 5 Star Plan`);
        handleNext();
    }
    return (
        <Box
                ...
                <Grid container spacing={2}>
                    <Grid item xs={12} lg={12}>
                        <Box sx={{ padding: 2, border: '2px solid red', borderRadius: '8px' }}>
                            ...
                            <ul>
                                <li style={{ fontSize: '0.875rem' }}>Extended Electric System Including Power Options in the Cabin</li>
                                <li style={{ fontSize: '0.875rem' }}>Cooling System Including Water Pump and Radiator</li>
                                <li style={{ fontSize: '0.875rem' }}>Front Suspension Components</li>
                                <li style={{ fontSize: '0.875rem' }}>Rear Suspension Components</li>
