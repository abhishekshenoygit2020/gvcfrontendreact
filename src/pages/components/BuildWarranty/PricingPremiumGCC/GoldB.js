...
export default function GoldB({ productIndex, setProductIndex, setProductName, setProductCost, handleNext }) {
    ...
    const ProductData = (e) => {
        setProductCost("1000");
        setProductName(`Gold Elite Plan`);
        handleNext();
    }
    return (
        <Box
                    ...
                    <Grid item xs={12} lg={12}>
                        <Box sx={{ padding: 2, border: '2px solid red', borderRadius: '8px' }}>
                            <Typography variant="h6" sx={{ fontSize: '1.3rem', fontWeight: 'bold', overflowWrap: 'break-word' }}>
                                <b>The Gold Elite Plan covers all Core Plan
Components and Systems PLUS the
following: </b>
                            </Typography>
