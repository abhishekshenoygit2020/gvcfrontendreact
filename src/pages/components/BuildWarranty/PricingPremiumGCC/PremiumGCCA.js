...
export default function PremiumGCCA({ productIndex, setProductIndex, setProductName, setProductCost, handleNext }) {
    ...
    const ProductData = (e) => {
        ...
        setProductName(`Premium GCC - 3 Star - No Per Claim Max(${tabLabels[value]})`);
        handleNext();
    }
    return (
        <Box
                        ...
                        <Grid item xs={12} lg={12}>
                            <Box sx={{ padding: 2, border: '2px solid red', borderRadius: '8px' }}>
                                <Typography variant="h6" sx={{ fontSize: '1.3rem', fontWeight: 'bold', overflowWrap: 'break-word' }}>
                                    <b>Premium GCC - 3 Star - No Per Claim Max ({tabLabels[index]})</b>
                                </Typography>
                                ...
                                <ul>
                                    ...
                                    <li style={{ fontSize: '0.875rem' }}>Transmission</li>
                                    ...
                                    <li style={{ fontSize: '0.875rem' }}>Sensors</li>
                                    <li style={{ fontSize: '0.875rem' }}>THEFT</li>
                                    <li style={{ fontSize: '0.875rem' }}>FIRE</li>
                                    <li style={{ fontSize: '0.875rem' }}>VANDALISM</li>
                                    <li style={{ fontSize: '0.875rem' }}>FLOOD OR WEATHER DAMAGE</li>
