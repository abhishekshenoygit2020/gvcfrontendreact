...
export default function EssentialA({ productIndex, setProductIndex, setProductName, setProductCost, handleNext }) {
    ...
    const ProductData = (e) => {
        setProductCost("500");
        setProductName(`Essential Powertrain Plan`);
        handleNext();
    }
    return (
        <Box
                    ...
                    <Grid item xs={12} lg={12}>
                        <Box sx={{ padding: 2, border: '2px solid red', borderRadius: '8px' }}>
                            <Typography variant="h6" sx={{ fontSize: '1.3rem', fontWeight: 'bold', overflowWrap: 'break-word' }}>
                                <b>The Following Components and Systems are Covered in the Essential Powertrain Plan  </b>
                            </Typography>
                            ...
                            <Typography variant="h6" sx={{ fontSize: '0.875rem', fontWeight: 'bold', }}>
                                Plans available for vehicles with less
                                than 500,000 KMs on the Odometer
                            </Typography>
                            <ul>
                            ...
                            <ul>
                                <li style={{ fontSize: '0.875rem' }}><b>Low $75 Deductible</b>All plans come with a $75 Per Claim
                                Deductible </li>
                                <li style={{ fontSize: '0.875rem' }}><b>Fast & Hassle-Free Claims
                                Adjudication:</b>GVC Prides itself on Fast & Hassle Free
Claims Adjudication. Customers can
choose their own Mechanic for Repairs.</li>
                                <li style={{ fontSize: '0.875rem' }}><b>Unlimited KM Option Available:</b>Our 1 or 2 Year Essential Powertrain
Plus Plans are eligible for the Unlimited
Milage Add on.</li>
                            </ul>
