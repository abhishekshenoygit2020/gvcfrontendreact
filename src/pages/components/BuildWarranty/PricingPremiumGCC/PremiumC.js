...
export default function PremiumC({ productIndex, setProductIndex, setProductName, setProductCost, handleNext }) {
    ...
    const ProductData = (e) => {
        setProductCost("1000");
        setProductName(`Premium 5 Star Hi-Tech Plan`);
        handleNext();
    }
    return (
        <Box
                    ...
                    <Grid item xs={12} lg={12}>
                        <Box sx={{ padding: 2, border: '2px solid red', borderRadius: '8px' }}>
                            <Typography variant="h6" sx={{ fontSize: '1.3rem', fontWeight: 'bold', overflowWrap: 'break-word' }}>
                                <b>The Following Components and Systems are Covered in the 5 Star Plan  </b>
                            </Typography>
                            ...
                            <ul>
                                <li style={{ fontSize: '0.875rem' }}>Navigation System</li>
                                <li style={{ fontSize: '0.875rem' }}>Entertainment System Including Front & Rear LCD Screens</li>
                                <li style={{ fontSize: '0.875rem' }}>Telephone System</li>
                                <li style={{ fontSize: '0.875rem' }}>Airbag Electronics</li>
                                <li style={{ fontSize: '0.875rem' }}>Other Elements</li>


                            </ul>
                            <Typography variant="h6" sx={{ fontSize: '0.875rem', fontWeight: 'bold', }}>
                                Factory installed components only
                            </Typography>
                            <Typography variant="h6" sx={{ fontSize: '0.875rem', fontWeight: 'bold' }}>
                                Features
                            </Typography>
                            <ul>
                                <li style={{ fontSize: '0.875rem' }}><b>Choose Our No Per Claim </b>Maximum With a $20,000 maximum liability our Premium Plans offer The Best In Class Coverage </li>
                                <li style={{ fontSize: '0.875rem' }}><b>Fast & Hassle-Free Claim Procedure:</b>GVC Prides itself on Fast & Hassle Free Claims Adjudication. Customers can choose their own Mechanic for Repairs.</li>
                            </ul>
