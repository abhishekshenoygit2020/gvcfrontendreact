...
export default function GoldC({ productIndex, setProductIndex, setProductName, setProductCost, handleNext }) {
    ...
    const ProductData = (e) => {
        setProductCost("1000");
        setProductName(`Gold Elite Hi-Tech Plan`);
        handleNext();
    }
    return (
        <Box
                    ...
                    <Grid item xs={12} lg={12}>
                        <Box sx={{ padding: 2, border: '2px solid red', borderRadius: '8px' }}>
                            <Typography variant="h6" sx={{ fontSize: '1.3rem', fontWeight: 'bold', overflowWrap: 'break-word' }}>
                                <b>The Gold Elite Hi-Tech Plan covers all
Core and Elite Plan Components and
Systems PLUS the following:</b>
                            </Typography>
