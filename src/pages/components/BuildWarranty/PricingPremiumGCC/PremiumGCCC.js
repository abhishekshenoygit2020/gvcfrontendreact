...
export default function PremiumGCCC({ productIndex, setProductIndex, setProductName, setProductCost, handleNext }) {
    ...
    const ProductData = (e) => {
        ...
        setProductName(`Gold Elite No Per Claim Max (${tabLabels[value]})`);
        handleNext();
    }
    useEffect(() => {
            if(productIndex) {
                        ...
                        <Grid item xs={12} lg={12}>
                            <Box sx={{ padding: 2, border: '2px solid red', borderRadius: '8px' }}>
                                <Typography variant="h6" sx={{ fontSize: '1.3rem', fontWeight: 'bold', overflowWrap: 'break-word' }}>
                                    <b>Gold Elite No Per Claim Max ({tabLabels[index]})</b>
                                </Typography>
                                ...
                                <Grid container spacing={2} justifyContent="flex-start">
                                    ...
                                    <Grid item xs={12}>
                                        ...
                                        >
                                            <b>Max Protection:</b> $2500 Per Claim Max (Maximum Contract Liability $20,000)
                                        </Button>
                                    </Grid>
                                    <Grid item xs={12}>
