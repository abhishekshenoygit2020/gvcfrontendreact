...
export default function PremiumGCCD({ productIndex, setProductIndex, setProductName, setProductCost, handleNext }) {
    ...
    const ProductData = (e) => {
        ...
        setProductName(`Gold Elite Hi-Tech $2500 Per Claim (${tabLabels[value]})`);
        handleNext();
    }
                        ...
                        <Grid item xs={12} lg={12}>
                            <Box sx={{ padding: 2, border: '2px solid red', borderRadius: '8px' }}>
                                <Typography variant="h6" sx={{ fontSize: '1.3rem', fontWeight: 'bold', overflowWrap: 'break-word' }}>
                                    <b>Gold Elite Hi-Tech $2500 Per Claim({tabLabels[index]})</b>
                                </Typography>
                                ...
                                <Grid container spacing={2} justifyContent="flex-start">
                                    ...
                                    <Grid item xs={12}>
                                        ...
                                        >
                                            <b>Max Protection:</b> $2500 Per Claim Max (Maximum Contract Liability $10,000)
                                        </Button>
                                    </Grid>
                                    <Grid item xs={12}>
