    ...
    <Grid item xs={12} lg={12}>
        <Box sx={{ padding: 2, border: '2px solid red', borderRadius: '8px' }}>
            <Typography variant="h6" sx={{ fontSize: '0.875rem' }} style={{ overflowWrap: 'break-word' }}>
                GAP Financial Protection Bundle - Max Liability: $25000 - Financed Amt: $25,001 - $50,000(96 Months)
            </Typography>
...
export default function GAPC({ productIndex, setProductIndex, setProductName, setProductCost, handleNext }) {
    ...
    const ProductData = (e) => {
        ...
        setProductName(`GAP Financial Protection Bundle - Max Liability: $25000 - Financed Amt: $25,001 - $50,000 (${tabLabels[value]})`);
        handleNext();
    }
    return (
        <Box
                        ...
                        <Grid item xs={12} lg={12}>
                            <Box sx={{ padding: 2, border: '2px solid red', borderRadius: '8px' }}>
                                <Typography variant="h6" sx={{ fontSize: '1.3rem', fontWeight: 'bold', overflowWrap: 'break-word' }}>
                                    <b>GAP Financial Protection Bundle - Max Liability: $25000 - Financed Amt: $25,001 - $50,000 ({tabLabels[index]})</b>
                                </Typography>
