...
export default function GAPA({productIndex, setProductIndex, setProductName, setProductCost,handleNext}) {
                        ...
                        <Grid item xs={12} lg={12}>
                            <Box sx={{ padding: 2, border: '2px solid red', borderRadius: '8px' }}>
                                <Typography variant="h6" sx={{ fontSize: '1.3rem', fontWeight: 'bold', overflowWrap: 'break-word' }}>
                                    <b>GAP Financial Protection Bundle - Max Liability: $7500 - Financed Amt: $0 - $75,000 ({tabLabels[index]})</b>
                                </Typography>
