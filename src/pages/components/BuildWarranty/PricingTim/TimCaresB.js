...
export default function TrimCaresB({ productIndex, setProductIndex, setProductName, setProductCost, handleNext }) {
    ...
    const ProductData = (e) => {
        ...
        setProductName(`Trim Care Tires - TIRE & RIM PLUS - Extended (${tabLabels[value]})`);
        handleNext();
    }
    return (
        <Box
                        ...
                        <Grid item xs={12} lg={12}>
                            <Box sx={{ padding: 2, border: '2px solid red', borderRadius: '8px' }}>
                                <Typography variant="h6" sx={{ fontSize: '1.3rem', fontWeight: 'bold', overflowWrap: 'break-word' }}>
                                    <b>Trim Care Tires - TIRE & RIM PLUS - Extended ({tabLabels[index]})</b>
                                </Typography>
                                ...
                                <ul>
                                    <li style={{ fontSize: '0.875rem' }}>TIRE & WHEEL COVERAGE - Flat Tires</li>
                                    <li style={{ fontSize: '0.875rem' }}>TIRE & WHEEL COVERAGE - Tire Replacement</li>
                                    <li style={{ fontSize: '0.875rem' }}>TIRE & WHEEL COVERAGE - Wheels (Rims)</li>
                                    <li style={{ fontSize: '0.875rem' }}>TIRE & WHEEL COVERAGE - Mounting and Balancing</li>
                                    <li style={{ fontSize: '0.875rem' }}>COSMETIC WHEEL REPAIR</li>
                                    <li style={{ fontSize: '0.875rem' }}>WINDSHIELD REPAIR PROTECTION</li>
                                    <li style={{ fontSize: '0.875rem' }}>WINDSHIELD REPLACEMENT PROTECTION</li>
                                    <li style={{ fontSize: '0.875rem' }}>KEY / REMOTE REPLACEMENT</li>                                   
                                </ul>
