...
const URL = "./dealership/getUserWarrantyGiftDetails";

function ViewSalesrepGiftCommission() {
    ...
    const loadDateData = async () => {
        ...
        if (new Date(toDate) <= new Date(fromDate)) {
            ...
            try {
                const response = await axios.post("dealership/getUserWarrantyGiftDetails", { dealership, fromDate, toDate });
...
export default ViewSalesrepGiftCommission;
