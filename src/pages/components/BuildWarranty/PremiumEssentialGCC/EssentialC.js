...
export default function EssentialC({ productIndex, setProductIndex, setProductName, setProductCost, handleNext }) {
    ...
    const ProductData = (e) => {
        ...
        setProductName(`Silver Powertrain $2500 Per Claim (${tabLabels[value]})`);
        handleNext();
    }
    return (
        <Box
                        ...
                        <Grid item xs={12} lg={12}>
                            <Box sx={{ padding: 2, border: '2px solid red', borderRadius: '8px' }}>
                                <Typography variant="h6" sx={{ fontSize: '1.3rem', fontWeight: 'bold', overflowWrap: 'break-word' }}>
                                    <b>Silver Powertrain $2500 Per Claim ({tabLabels[index]})</b>
                                </Typography>
