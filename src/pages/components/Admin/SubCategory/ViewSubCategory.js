...
const URL = "./category/getsubcategory";
...
function ViewSubCategory() {
        ...
        return (
            <Tooltip title="Edit">
                <EditIcon style={{ cursor: "pointer" }} onClick={(e) => {
                    e.stopPropagation();
                    navigate('/AddSubCategory', { state: { type: "update", value: props.selectedRow } });
                ...
                <DeleteIcon style={{ cursor: "pointer" }}
                    onClick={() => {
                        ...
                        if (isConfirmed) {
                            ...
                            const mainURL = 'dealership/' + data.id + '/deletesByIdsubcategory';
    ...
    const handleSubmit = (e) => {
        navigate('/AddSubCategory', { state: { type: "add", value: "" } });
        // const method = "POST";
