...
const URL = "./product/getSalesrepProduct";

function ViewSalesrepWarrantyProduct() {
    ...
    const columns = [
        ...
        { field: "salesrepname", headerName: "Salesrep", width: 200 },
        { field: "subcategory", headerName: "Sub Category Name", width: 450 },
        {
            field: 'actions',
            type: 'actions',
            headerName: 'Actions',
        ...
        return (
            <Tooltip title="Edit">
                <EditIcon style={{ cursor: "pointer" }} onClick={(e) => {
                    ...
                    navigate('/WarrantyProducts', { state: { type: "updateSalerepProduct", value: props.selectedRow } });
                }} />
            </Tooltip>
                ...
                <DeleteIcon style={{ cursor: "pointer" }}
                    onClick={() => {
                        ...
                        if(isConfirmed){
                            ...
                            const mainURL = 'product/' + data.id + '/deletesByIdSalesrepProduct';
...
export default ViewSalesrepWarrantyProduct;
