...
function UpdateSubCatDealershipVisiblity() {
    ...
    useEffect(() => {
        ...
        if (value.dealershipVisiblity === null) {
            setId(value.id);
            setSubCategoryName(value.subcat + " " + value.warrantyProtection);
            loadData();
        } else {
            setId(value.id);
            setSubCategoryName(value.subcat + " " + value.warrantyProtection);
    ...
    const handleSubmit = (e) => {
        ...
        const mainURL = "./category/" + id + "/updateDealershipSubCategory";
                    ...
                    components={{
                        Toolbar: () => (
                            ...
                            >
                                ...
                                >
                                    {subCategoryName + " Visiblity for Dealerships"}
                                </Typography>
                            </Box>
                        ),
                    }}
...
export default UpdateSubCatDealershipVisiblity;
