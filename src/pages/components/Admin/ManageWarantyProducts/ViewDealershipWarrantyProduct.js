...
const URL = "./product/getDealershipProduct";

function ViewDealershipWarrantyProduct() {
        ...
        return (
            <Tooltip title="Edit">
                <EditIcon style={{ cursor: "pointer" }} onClick={(e) => {
                    ...
                    navigate('/WarrantyProducts', { state: { type: "updateDealershipProduct", value: props.selectedRow } });
                }} />
            </Tooltip>
...
export default ViewDealershipWarrantyProduct;
